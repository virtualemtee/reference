function nextTab(step) {
 ...
 if (step === 6) {
  ...
  // Calculate Mark (shift + contour)
  const mark = contourOffset + shiftOffset;

  // Final gauge after adding reference gauge
  const finalGauge = refGauge + mark;
  ...
  document.getElementById('markResult').textContent = mark;
